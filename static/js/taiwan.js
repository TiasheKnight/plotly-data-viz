...
function drawBoxPlot(gender) {
  const fileName = `../static/data/83年1月至113年10月死亡人口按區域(${gender}).csv`;
...
function drawAnimationMap() {
  const geoJsonFile = "../static/data/taiwan_geo.json";
  const csvFile = "../static/data/83年1月至113年10月死亡人口按區域(全).csv";
...
function drawLineChart1() {
  const fileName = `../static/data/96至112年火化數.csv`;
  const fileName2 = `../static/data/96至112年環保葬數量.csv`;
  let years = [];
  let fired_counts = [];
  let park_counts = [];
  let ocean_counts = [];
...
function drawLineChart2() {
  const fileName = `../static/data/96至112年環保葬數量.csv`;
  let years = [];
  let park_counts = [];
  let ocean_counts = [];
  let tree_counts = [];
...
function drawBarChart() {
  const fileName = `../static/data/96至112年殯儀館.csv`;
  const fileName2 = `../static/data/96至112年死亡統計.csv`;
  let years = [];
  let total_deaths = [];
  let funeral_homes = [];
